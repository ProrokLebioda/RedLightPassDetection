// RedLightViolationDetection.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
#include "detector.h"
#include <iostream>
...
int main(int argc, const char** argv)
{
	...
	if (!capture.open("data/CarsDrivingUnderBridge.mp4"))
	{
		cout << "Could not read video" << endl;
		return 1;
	}
	double t = 0;
